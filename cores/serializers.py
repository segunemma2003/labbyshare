...
class UserSerializer(serializers.ModelSerializer):
    ...
    managed_regions = RegionSerializer(many=True, read_only=True)
    
    class Meta:
        model = User
        fields = [
            'id', 'uid', 'first_name', 'last_name', 'email', 'phone_number',
            'profile_picture', 'date_of_birth', 'gender', 'user_type',
            'current_region', 'managed_regions', 'profile_completed', 'created_at'
        ]
...
class CategoryAddOnSerializer(serializers.ModelSerializer):
    addon = AddOnSerializer(read_only=True)
    
    class Meta:
        model = CategoryAddOn
        fields = ['id', 'addon', 'price', 'is_active']
